...
total_spending = st.number_input("Total Spending", min_value = 0, max_value = 5_000, value = 1_000)
...
num_web_visits_month = st.number_input("Number of Web Visits per Month", min_value = 0, max_value = 50, value = 5)
...
if st.button("Predict Segment"):
    ...
    st.success(f"The Predicted segment: Cluster {cluster}")
